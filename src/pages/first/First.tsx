...
const triangle = { kind: 'triangle', base: 10, height: 10 } as const
...
export const First = () => {
  ...
  const getUsersOnLineMessage = (numUsersOnLine: number): string => {
    if (numUsersOnLine) {
      if (numUsersOnLine > 1) {
  ...
  return (
    <div>
      ...
      <p>area circle {getArea(circle)} cms2.</p>
      <p>area square {getArea(square)} cms2.</p>
      <p>area rectangle {getArea2(rectangle)} cms2.</p>
      <p>area triangle {getArea2(triangle)} cms2.</p>
    </div>
  )
}
